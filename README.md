...
- プラグイン一覧にあるツクールMZ移植版を公開する場合、<s>必ず移植前の作者名（=下表を参照）と、</s>移植後の作者名（=当方）を明記するようお願い致します。
<br>
...
| ARTM_StatePopupCommandMZ | バトル中に対象者（アクター/エネミー）のステート詳細を確認することができるコマンドを追加します。<br>※本プラグインは過去にサブアカウントにて別サイトに投稿したリクエストプラグインです。|
