# ご使用上の注意
- 本プロジェクトでは、当方が作成したプラグイン（以降は「本プラグイン」と記載）のみを公開しております。
  本プラグインはMITライセンスの範囲内で使用可能です。
- 当方は、本プラグインの使用により発生した如何なる責任を負わないものとします。
- 本プラグインは、当方のオリジナルプラグインと、他作者様のツクールMV版プラグインをツクールMZ版に移植したプラグイン、の2種類があります。
  とくに、ツクールMZ版に移植したプラグインを公開する場合、必ず移植前の作者名（=下表を参照）と、移植後の作者名（=当方）を明記するようお願い致します。
- 本プラグインを改造して公開した場合、改造前の作者名（=当方）と、改造後の作者名（=改造された方）を明記するようお願い致します。
<br>
